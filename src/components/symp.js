                            ...
                            <div class="">
                                <div class="card-body wow fadeInUp">
                                    <ul>
                                        <li>Headache :
                                <center>
                                    <img data-src="images/assets/technologies/headache.png" class="img-fluid" alt="Robotic illustration of how many different things it can do" width="200" height="50%" />
                                </center>
